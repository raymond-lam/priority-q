[![Build Status](https://travis-ci.org/raymond-lam/priority-q.svg?branch=master)](https://travis-ci.org/raymond-lam/priority-q) [![Greenkeeper badge](https://badges.greenkeeper.io/raymond-lam/priority-q.svg)](https://greenkeeper.io/)
